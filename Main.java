...
public class Main 
{
    public static void main(String[] args) 
    {
        ...
        while (inputFile.hasNextLine()) {
            ...
            Plant currePlant = new Plant(currentLine);
            myPlants.add(currePlant);
            System.out.println("Added new plant with following info: " + currePlant.getName());
        }
